...
import { ArrowLeft, Calendar, MapPin, Clock, Users, CreditCard, Ticket, Star, Share2 } from "lucide-react"
...
const eventDatabase: { [key: string]: EventData } = {
  "sacred-winds-tour-2024": {
    ...
    ticketTypes: [
      ...
      },
      {
        ...
        available: 200,
        maxPerOrder: 6,
        benefits: ["Reserved seating", "Early venue entry", "Merchandise discount"],
      },
      {
        id: "vip",
        name: "VIP Experience",
    ...
    ticketTypes: [
      {
        ...
        available: 800,
        maxPerOrder: 10,
        benefits: ["Festival access", "Traditional food vendors", "Cultural workshops"],
      },
      {
        id: "premium",
        ...
        available: 150,
        maxPerOrder: 6,
        benefits: ["Premium viewing area", "Meet & greet", "Exclusive merchandise", "Traditional meal included"],
      },
    ],
  ...
  "summer-solstice-2024": {
    ...
    image: "/placeholder.svg?height=400&width=800&text=Summer+Solstice+Celebration",
    ticketTypes: [
      {
        id: "ceremony",
        ...
        available: 500,
        maxPerOrder: 6,
        benefits: ["Ceremony participation", "Traditional feast", "Cultural education"],
      },
      {
        id: "full-experience",
        ...
        available: 200,
        maxPerOrder: 4,
        benefits: ["All ceremony access", "VIP seating", "Traditional gifts", "Elder storytelling session"],
      },
    ],
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-24 pb-8 bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          >
            <Link href="/#events" className="hover:text-pink-500 transition-colors flex items-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              <div className="flex items-center justify-between">
                <h1 className="text-3xl md:text-4xl font-bold lg:hidden">{event.title}</h1>
                <Button
                  onClick={handleShare}
                  variant="outline"
              ...
              <div className="flex flex-wrap gap-2">
                {event.genre.map((g) => (
                  <Badge key={g} variant="outline" className="border-amber-600 text-amber-600">
                    {g}
                  </Badge>
                ))}
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-400">(4.9) Based on previous shows</span>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-12 bg-gray-900">
        <div className="container mx-auto px-4">
              ...
              {[1, 2, 3].map((step) => (
                <div key={step} className="flex items-center">
                  ...
                  <span className={`ml-2 ${currentStep >= step ? "text-white" : "text-gray-400"}`}>
                    {step === 1 ? "Select Tickets" : step === 2 ? "Customer Info" : "Confirmation"}
                  </span>
          ...
          {currentStep === 1 && (
            ...
            >
              <h2 className="text-2xl font-bold mb-8 text-center">Select Your Tickets</h2>

              <div className="space-y-6">
                {event.ticketTypes.map((ticketType) => (
                  <Card key={ticketType.id} className="bg-gray-800 border-gray-700">
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-4 mb-2">
                            <h3 className="text-xl font-bold">{ticketType.name}</h3>
                            <span className="text-2xl font-bold text-pink-500">${ticketType.price}</span>
                          </div>
                          <p className="text-gray-400 mb-3">{ticketType.description}</p>
                          ...
                          <p className="text-sm text-gray-500 mt-2">
                            {ticketType.available} tickets available • Max {ticketType.maxPerOrder} per order
                          </p>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                          <div className="flex items-center border border-gray-600 rounded-lg">
                            <button
                              onClick={() =>
                                updateTicketQuantity(ticketType.id, (selectedTickets[ticketType.id] || 0) - 1)
                              }
                            ...
                            <button
                              ...
                              disabled={
                                (selectedTickets[ticketType.id] || 0) >=
                                Math.min(ticketType.available, ticketType.maxPerOrder)
                              }
                            >
                              +
                            </button>
          ...
          {currentStep === 2 && (
            ...
            >
              <h2 className="text-2xl font-bold mb-8 text-center">Customer Information</h2>
              ...
              <Card className="bg-gray-800 border-gray-700">
                <CardContent className="p-6">
                  ...
                  <div className="flex gap-4">
                    <Button onClick={() => setCurrentStep(1)} variant="outline" className="flex-1 border-gray-600">
                      Back
                    </Button>
                    <Button
            ...
            >
              <div className="bg-green-500/20 border border-green-500/50 rounded-lg p-8 mb-8">
                ...
                <p className="text-gray-300 mb-6">
                  Your tickets have been booked successfully. You will receive a confirmation email with your tickets
                  shortly.
                </p>
