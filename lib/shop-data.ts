...
export const products: Product[] = [
  {
    id: "ancient-ruin-cd",
    name: "Restoring the Ancient Ruins CD",
    price: 20.0,
    category: "music",
    image: "/images/ancient-ruin.avif",
    description:
      "Our latest album featuring traditional indigenous sounds with modern worship",
    stripeProductId: "prod_ancient-ruin-cd",
    stripePriceId: "price_ancient-ruin-cd",
    inventory: 999,
    featured: true,
  },
  {
    id: "sacred-fire-digital",
    name: "Sacred fire - Digital Album",
    price: 12.99,
    category: "music",
    image: "/images/sacred-fire-album.avif",
    description:
      "Our latest album featuring traditional indigenous sounds with modern worship",
    stripeProductId: "prod_sacred_fire_digital",
    stripePriceId: "price_sacred_fire-digital",
    inventory: 999,
    featured: true,
  },
  {
    id: "black-okama-t-shirt",
    name: "Black OKAMA T-Shirt",
    price: 20.0,
    category: "apparel",
    image: "/images/okama-t-shirt.avif",
    description: "Black OKAMA T-Shirt",
    stripeProductId: "black-okama-t-shirt",
    stripePriceId: "black-okama-t-shirt",
    inventory: 999,
    featured: true,
  },
  // {
